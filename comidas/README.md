...
- Usa la fecha de hoy y detecta el momento por la hora (editable en ⚙️):
  ...
  Se puede cambiar el momento con los botones, o el día en la tira semanal de arriba (tocá un día; puntitos de color = lo registrado ese día; ‹ › cambian de semana, el nombre del mes abre una fecha cualquiera y "↺ Hoy" vuelve a hoy).
