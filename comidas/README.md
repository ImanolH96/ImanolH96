...
- **Botonera circular estilo Simon**: el anillo tiene 🍔 Comida fuera del plan, 🍷 Alcohol y 🍰 Dulce (⅓ cada una; las tres forman una comida libre) y el centro es 🍽️ Comida libre completa (1). Cada parte se hunde e ilumina al tocarla; la ya sumada queda con borde blanco y ✓, y otro toque la saca.
