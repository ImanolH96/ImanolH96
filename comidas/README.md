...
- Ajuste del mes (solo el mes actual): una frase con lo que queda del mes y cuánto por semana para cerrar en el plan (o, si te pasaste, qué hacer para no sumar desvío), y una línea punteada en la gráfica Acumulado con el margen hasta fin de mes.
